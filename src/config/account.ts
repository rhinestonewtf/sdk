...
interface BaseTransaction {
   ...
   * omitting it: `{ include: [] }` (or an exclude covering every venue) means
   * no venue may serve the swap, and the request fails rather than falling back
   * to an unconstrained route.
   */
