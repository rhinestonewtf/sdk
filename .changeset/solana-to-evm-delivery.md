...
- Unsupported shapes are refused before a quote is requested: destination instructions, HyperCore actions, more than one source or destination token, mixed-VM sources, and a non-EVM destination.
