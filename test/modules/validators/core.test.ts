...
import {
    ...
    getMockSignature
} from '../../../src/modules/validators/core'
...
describe('Validators Core Tests', () => {
    ...
    describe('getWebAuthnValidator', () => {
        ...
        it.skip('should parse Hex public key input', () => {
            expect(true).toBe(true)
        })

        it.skip('should throw an error for compressed public keys', () => {
            expect(true).toBe(true)
        })
    })

    describe.skip('parsePublicKey', () => {
